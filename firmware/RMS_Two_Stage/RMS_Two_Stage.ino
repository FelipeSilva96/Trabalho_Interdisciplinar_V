...
const char* serverUrl = "http://192.168.1.4:3333/api/events"; //<-  o IP "192.168.1.4" é apenas um exemplo, e deve ser trocado pelo IP da máquina em que o servidor está rodando
